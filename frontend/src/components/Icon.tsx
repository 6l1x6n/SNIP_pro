...
export type IconName =
  | 'search' | 'file' | 'download' | 'copy' | 'link' | 'external'
  | 'star' | 'bolt' | 'mic' | 'sun' | 'moon' | 'lock'
  | 'chevronDown' | 'chevronLeft' | 'chevronRight'
  | 'arrowLeft' | 'arrowRight' | 'arrowUpDown'
  | 'filter' | 'check' | 'checkCircle' | 'alertCircle' | 'close'
  | 'thumbUp' | 'thumbDown' | 'lightbulb' | 'keyboard' | 'clock' | 'flame'
  | 'user' | 'settings' | 'key' | 'help' | 'card' | 'logout'
  | 'edit' | 'shield' | 'plus' | 'refresh' | 'zoomIn' | 'list' | 'trash'
  | 'pin' | 'panelLeft'
...
const PATHS: Record<IconName, ReactNode> = {
  ...
  star: <path d="M12 2.5l2.9 6.26 6.6 1.04-4.75 4.87L17.8 21.5 12 18.27 6.2 21.5l1.05-6.83L2.5 9.8l6.6-1.04z" />,
  bolt: <path d="M13 10V3L4 14h7v7l9-11h-7z" />,
  mic: <><path d="M12 1a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" /><path d="M19 10v1a7 7 0 0 1-14 0v-1M12 18v4M8 22h8" /></>,
  ...
  arrowUpDown: <><path d="M7 4v16M7 20l-3-3M7 20l3-3" /><path d="M17 20V4M17 4l-3 3M17 4l3 3" /></>,
  ...
  key: <><path d="m21 2-2 2" /><path d="m15.5 7.5 3 3L22 7l-3-3" /><path d="M11.39 11.61a5.5 5.5 0 1 1-7.78 7.78 5.5 5.5 0 0 1 7.78-7.78zm0 0L15.5 7.5" /></>,
  help: <><circle cx="12" cy="12" r="9" /><path d="M9.1 9a3 3 0 0 1 5.82 1c0 2-3 3-3 3M12 17h.01" /></>,
  card: <><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M2 10h20M6 15h2M11 15h2" /></>,
  ...
  pin: <><path d="M9 3h6l1 8 3 3H5l3-3z" /><path d="M12 14v7" /></>,
